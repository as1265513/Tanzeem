      ...
      switch(type)
      {
        ...
        case "Address":
          ...
          case "Phone":
            ...
            break;
            case "nn":
              if(fullNameValid && PhoneValid && EmailValid && PasswordValid && CpassValid && AddressValid  && Password === Cpass )
              { 
...
<View style={styles.UpperContainer}>
          <Text style={{...styles.crtStyle,fontFamily:'FingerPaint'}} >Create Account</Text>
          <Image
...
const styles = StyleSheet.create({
 ...
 backgroundColor:'#000'
  ...
  Createbtn:{position:'absolute' ,flexDirection:'row',bottom:200,right:30 },
  Createbtntxt:{fontSize:25,marginHorizontal:5,fontFamily:'IndieFlower'},
  CreatebtnIcon:{borderRadius:20,paddingHorizontal:10,backgroundColor:'#000'},
  ...
  mediaIcon:{backgroundColor:'#000',height:50,width:50,justifyContent:'center',alignItems:'center',borderRadius:50,marginHorizontal:30},
});
